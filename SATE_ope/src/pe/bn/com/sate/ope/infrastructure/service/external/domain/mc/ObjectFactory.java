...
public class ObjectFactory {
    ...
    private final static QName _ConsultaMovimientosXml_QNAME = new QName("http://tempuri.org/", "xml");
    ...
    public JAXBElement<String> createConsultaMovimientosXml(String value) {
        return new JAXBElement<String>(_ConsultaMovimientosXml_QNAME, String.class, ConsultaMovimientos.class, value);
    }
    ...
    public JAXBElement<String> createAperturaTarjetasXml(String value) {
        return new JAXBElement<String>(_ConsultaMovimientosXml_QNAME, String.class, AperturaTarjetas.class, value);
    }
    ...
    public JAXBElement<String> createModificacionTarjetasXml(String value) {
        return new JAXBElement<String>(_ConsultaMovimientosXml_QNAME, String.class, ModificacionTarjetas.class, value);
    }
    ...
    public JAXBElement<String> createModificacionClientesXml(String value) {
        return new JAXBElement<String>(_ConsultaMovimientosXml_QNAME, String.class, ModificacionClientes.class, value);
    }
    ...
    public JAXBElement<String> createCashInXml(String value) {
        return new JAXBElement<String>(_ConsultaMovimientosXml_QNAME, String.class, CashIn.class, value);
    }
    ...
    public JAXBElement<String> createAnulacionesXml(String value) {
        return new JAXBElement<String>(_ConsultaMovimientosXml_QNAME, String.class, Anulaciones.class, value);
    }
    ...
    public JAXBElement<String> createAperturaClientesXml(String value) {
        return new JAXBElement<String>(_ConsultaMovimientosXml_QNAME, String.class, AperturaClientes.class, value);
    }

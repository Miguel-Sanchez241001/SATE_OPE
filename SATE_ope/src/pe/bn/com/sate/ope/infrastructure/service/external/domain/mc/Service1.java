 ...
 * 
 */
@WebServiceClient(name = "Service1", targetNamespace = "http://tempuri.org/", wsdlLocation = "WEB-INF/wsdl/Service1.svc.wsdl")
    ...
    extends Service
{
    ...
    static {
        SERVICE1_WSDL_LOCATION = pe.bn.com.sate.ope.infrastructure.service.external.domain.mc.Service1 .class.getResource("WEB-INF/wsdl/Service1.svc.wsdl");
        WebServiceException e = null;
        if (SERVICE1_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'WEB-INF/wsdl/Service1.svc.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
